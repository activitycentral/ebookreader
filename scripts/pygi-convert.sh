...
\
    ...
    -pe "s/from gobject/from gi.repository.GObject/g;" \
\
...
\
    ...
    -pe "s/(?<!\.)gdk\./Gdk\./g;" \
\
    -pe "s/webkit.WebView/WebKit.WebView/g;" \
\
    -pe "s/import evince//g;" \
    -pe "s/evince/EvinceView/g;" \
    -pe "s/EvinceView.SIZING_/EvinceView.SizingMode./g;" \
    -pe "s/EvinceView.JobFind/EvinceView.JobFind.new/g;" \
    -pe "s/EvinceView.JOB_/EvinceView.JobPriority./g;" \
\
    -pe "s/evince.document_factory_get_document/EvinceDocument.Document.factory_get_document/g;" \
    ...
    -pe "s/Gtk.SCROLL_/Gtk.ScrollType.\1/g;" \
